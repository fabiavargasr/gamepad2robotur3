...
def modelo_traj(joint_angles,x,y,z,rx,ry,rz):
  ...
  #  print("Joint angles:")
    print(joint_angles)
  #  ee_pose[0]=ee_pose[0]+1.57
    print(joint_angles)
    
    
    ee_pose =ur3e_arm.forward(joint_angles, 'matrix')
    ...
    ee_pose[0,3]=ee_pose[0,3]
    ee_pose[1,3]=ee_pose[1,3]
    ee_pose[2,3]=ee_pose[2,3]
...
#             rospy.init_node("test_move", anonymous=True, disable_signals=True)
       ...
       #move1()
        ...
        try:
            ...
            Q1=modelo_traj(joints_pos,xx,yy,zz,rx1,ry1,rz1)
            print Q1
...
def main():
    ...
    try:
        ...
        print "hola listo ..."
        path=tray_circular(10)
        path_ar = np.array(path)
        print "rta", path_ar
        
        print "pate"
        msg2=[[path_ar[0][3], path_ar[1][3], path_ar[2][3],0,0,0],[path_ar[0][4], path_ar[1][4], path_ar[2][4],0,0,0],[path_ar[0][5], path_ar[1][5], path_ar[2][5],0,0,0]]
        print msg2
