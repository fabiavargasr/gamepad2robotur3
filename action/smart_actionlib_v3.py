...
def modelo(joint_angles,x,y,z):
   
   # print("joint que llega:")
  #  print(np.round(joint_angles, decimals=1))   
    joint_angles = np.round(joint_angles, decimals=1) # in radians
  ...
  #  print("Joint angles:")
   # print(joint_angles)
    ...
    ee_pose[0,3]=ee_pose[0,3]+x/20
    ee_pose[1,3]=ee_pose[1,3]+y/20
    ee_pose[2,3]=ee_pose[2,3]+z/20
